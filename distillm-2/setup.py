...
stale_egg_info = Path(__file__).parent / "distillm2.egg-info"
...
setup(
    ...
    version="0.1.0.dev0",
    author="Jongwoo Ko",
    author_email="jongwoo.ko@kaist.ac.kr",
    description="The Official Code Implementation for DistiLLM-2",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    license="Apache",
    url="https://github.com/jongwooko/distillm-2",
    package_dir={"": "src"},
